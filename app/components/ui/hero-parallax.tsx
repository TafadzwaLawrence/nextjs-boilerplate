...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-4xl font-bold font-mono dark:text-white">
        The Ultimate Human<br /> development studio
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 font-mono">
        ...
        I am a passiomate developer and designer that love to build
        amazing products.
      </p>
    </div>
  );
